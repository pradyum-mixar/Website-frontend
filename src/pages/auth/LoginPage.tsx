...
export function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    // We would use the same logic here to initiate Google SSO, 
    // redirecting back with returnTo preserved
  };
    ...
    <main className="page-container">
      <div className="card">
        ...
        <form className="form" onSubmit={onSubmit}>
          ...
          <button type="button" className="btn-google" onClick={handleGoogleLogin} style={{ display: "none" }}>
