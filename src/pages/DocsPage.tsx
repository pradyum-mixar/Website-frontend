        ...
        <aside className="docs-sidebar">
          ...
          {TOC.map((section) => (
            <div key={section.id} className="docs-toc-section">
              <button className="docs-toc-section-title" onClick={() => scrollTo(section.id)}>
                {section.label}
              </button>
        ...
        <main className="docs-content">
          ...
          <div className="docs-header">
            ...
            <p className="docs-header-description">
              ...
              images and 3D models to layer-based texturing and conversational scene building.
            </p>
          </div>
          ...
          <section id="moodboard" className="docs-section">
            ...
            <div id="image-to-3d" className="docs-feature">
              ...
              <ol className="docs-steps">
                <li>
                  Add your source image to the moodboard (drag and drop, clipboard paste, or import)
                </li>
                <li>
                  Select the image and choose <strong>Image to 3D</strong> from the AI function menu
                </li>
                <li>
                  Configure your output settings — texture resolution (512px–4096px), mesh detail
                  level, output format (GLB, USDZ, FBX, OBJ, STL), and material type
                </li>
                <li>
                  Start the generation. The model typically takes a few minutes to process.
                </li>
                <li>
              ...
              <p>
                The output quality depends heavily on the input image. Clean, well-lit images with a
                clear subject produce the best results. Generated models are a strong starting point,
                but they'll often benefit from cleanup — topology may need retopology for animation or
                game use, textures may need refinement in Layer Painting, and scale and orientation may
                need adjustment.
              </p>
              ...
              <div className="docs-tip">
                ...
                <ul className="docs-list">
                  ...
                  <li>
                    Some generation modes support multi-view reconstruction for higher accuracy
                  </li>
                  <li>
                    Use this alongside Image Generation: generate a concept image, then immediately
                    convert it to 3D
                  </li>
                </ul>
              </div>
            ...
            <div id="segment-to-3d" className="docs-feature">
              ...
              <ol className="docs-steps">
                ...
                <li>
                  Select <strong>Segment to 3D</strong> from the AI function menu
                </li>
                <li>
                  Identify the objects you want to extract using:{" "}
                  <strong>Text</strong> (describe what to select), <strong>Point</strong> (click on
                  the object), <strong>Bounding box</strong> (draw a rectangle), or{" "}
                  <strong>Mask</strong> (paint a selection)
                </li>
                <li>Mixar creates masks for each selected segment</li>
                <li>Each segmented object is individually converted into a 3D model</li>
                <li>
                  All generated models are placed together in a scene, preserving their spatial
                  relationships from the original image
                </li>
              </ol>
